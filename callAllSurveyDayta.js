// Create Dropdown, Button, and Progress Bar
(function createDropdownButtonProgress() {
  ...
  container.innerHTML = `
    ...
    <div id="progressBar" style="width: 100%; height: 6px; background: #eee; display: none;">
...
// Button Click Logic with Progress Bar
